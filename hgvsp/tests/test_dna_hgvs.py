...
class TestEventValidators(TestCase):
    def test_valid_substitutions_pass(self):
        ...
        for c in constants.dna_prefix:
            self.assertIsNotNone(
                substitution_re.fullmatch('{}.123A>G'.format(c)))
    ...
    def test_valid_deletions_pass(self):
        ...
        self.assertIsNotNone(deletion_re.fullmatch(
    ...
    def test_does_not_match_invalid_deletions(self):
        ...
        self.assertIsNone(
            deletion_re.fullmatch('4071+1_4072-1_5154+1_5155-1del'))
    ...
    def test_does_not_match_invalid_insertions(self):
        ...
        self.assertIsNone(insertion_re.fullmatch(
            '(4071+1_4072)-(1_5154+1_5155-1)ins'))
    ...
    def test_does_not_match_invalid_delins(self):
        ...
        self.assertIsNone(
            delins_re.fullmatch('(4071+1_4072)-(1_5154+1_5155-1)delins'))
    ...
    def test_single_var_re_matches_each_variant_type(self):
        ...
        self.assertIsNotNone(
            single_variant_re.fullmatch(
                'g.(4071+1_4072-1)_(5154+1_5155-1)del'))
        self.assertIsNotNone(

...
class TestEventValidators(TestCase):
    ...
    def test_does_not_match_invalid_substitutions(self):
        ...
        # ambiguity characters are not considered matches in MAVE-HGVS
        self.assertIsNone(substitution_re.fullmatch("123A>N"))
        self.assertIsNone(substitution_re.fullmatch("54G>H"))
    ...
    def test_does_not_match_invalid_deletions(self):
        ...
        self.assertIsNone(deletion_re.fullmatch("(?_-245)_(31+1_32-1)del"))
        self.assertIsNone(deletion_re.fullmatch("(?_-1)_(*1_?)del"))
    ...
    def test_does_not_match_invalid_insertions(self):
        ...
        self.assertIsNone(insertion_re.fullmatch("761_762insNNNNN"))
        self.assertIsNone(insertion_re.fullmatch("761_762insN"))
    ...
    def test_does_not_match_invalid_delins(self):
        ...
        self.assertIsNone(delins_re.fullmatch("?_6777delinsC"))
        self.assertIsNone(delins_re.fullmatch("*?_45+1delinsC"))
        self.assertIsNone(delins_re.fullmatch("?_?delinsC"))
...
class TestVariantRegexPatterns(TestCase):
    ...
    def test_multi_var_re_does_not_match_invalid_multi_variants(self):

...
any_variant = rf"(?:(?P<reference_id>\w+):)?(?P<single_variant>{r'|'.join([dna_single_variant, rna_single_variant, pro_single_variant])})|(?P<multi_variant>{r'|'.join([dna_multi_variant, rna_multi_variant, pro_multi_variant])})"
